...
def main():
    ...
    print()
    print("Interpretation (CORRECTED 2026-09-23 -- do not use 'condensation longest path',")
    print("                and do NOT call this NP-hard or claim scheduling optimality):")
    ...
    print("  But for ANY digraph without self-loops, splitting the edges by any total order into")
    print("  'forward' and 'backward' gives two acyclic classes, so the answer is always")
    print("     0 (no edges) | 1 (non-empty acyclic) | 2 (contains a cycle).")
    print("  This enumeration therefore verifies a TRIVIAL CLASSIFICATION, not an optimality theorem:")
    ...
    print("  schedule (Theorem 2). The two-pass scheme is optimal only in the narrow sense that the")
    print("  number of COMPLETE STAGE TRAVERSALS cannot be reduced further -- nothing about CPU")
    print("  time, end-to-end latency, or scheduling in general.")
